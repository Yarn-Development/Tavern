...
module.exports = {
  ...
  */
	run: async (client, interaction) => {
		function random_number() { return Math.floor(Math.random() * 3);}
		...
		const step = ['Pick', 'Basket', 'Move'];const grapes_required = 10;
        ...
        const embed = msg.embeds[0];
							...
							if (current_grapes === 10) 
                {
                  ...
                  embed.fields[1] = (
                    {
                      ...
                      value: '[here!](https://discord.com/oauth2/authorize?client_id=840249307030487050&permissions=8&scope=bot%20applications.commands)',
                      inline: true 
                  });
                  embed.fields[2] = (
                    {
                  ...
                  if (storage === 'global') {
                    ...
                    client.db.add(`bal_${interaction.user.id}.${interaction.guild.id}`, 100);
                  } else if (!storage) {
                    interaction.followUp(
            ...
            'Sorry, but you didn\'t pick enough grapes in time.\nPlease try again later.';
						embed.description = 
            'You have not earned any :grapes:.';
            embed.fields[0] = (
              {
                name:'This minigame has ended.',
                value: 'Thank you for playing!',
              ...
              {
                name: 'Invite me to your server',
                value: '[Here :D](https://discord.com/oauth2/authorize?client_id=840249307030487050&permissions=8&scope=bot%20applications.commands)',
                inline: true 
            });
						embed.fields[2] = (
              {
